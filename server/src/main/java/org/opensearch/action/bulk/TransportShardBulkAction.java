...
public class TransportShardBulkAction extends TransportWriteAction<BulkShardRequest, BulkShardRequest, BulkShardResponse> {
    ...
    private final PerfStatsMonitorService perfStatsMonitorService;
    ...
    public TransportShardBulkAction(
        ...
        PerfStatsMonitorService perfStatsMonitorService,
        ...
        this.perfStatsMonitorService = perfStatsMonitorService;
    ...
    protected void dispatchedShardOperationOnPrimary(
        ...
        }), listener, threadPool, executor(primary), clusterService.localNode().getId(), perfStatsMonitorService);
    }
    ...
    public void performOnPrimary(
        ...
        new ActionRunnable<PrimaryResult<BulkShardRequest, BulkShardResponse>>(listener) {
            ...
            private void finishRequest() {
                NodePerfStats nodePerfStats = new NodePerfStats(perfStatsMonitorService.getCPUEWMA(), perfStatsMonitorService.getMemoryEWMA(), perfStatsMonitorService.getIOEWMA());
