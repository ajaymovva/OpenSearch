...
public class AdmissionControlActionsMap {
    ...
    static {
        ...
        transportActionsMap.put(BulkAction.NAME + "[s][p]", AdmissionControlActionType.INDEXING.getType());
        transportActionsMap.put(SearchTransportService.QUERY_ACTION_NAME, AdmissionControlActionType.SEARCH.getType());
        transportActionsMap.put(SearchTransportService.QUERY_ID_ACTION_NAME, AdmissionControlActionType.SEARCH.getType());
        transportActionsMap.put(SearchTransportService.DFS_ACTION_NAME, AdmissionControlActionType.SEARCH.getType());
        transportActionsMap.put(SearchTransportService.FETCH_ID_ACTION_NAME, AdmissionControlActionType.SEARCH.getType());
    }
