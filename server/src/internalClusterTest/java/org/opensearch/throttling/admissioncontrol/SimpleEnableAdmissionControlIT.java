...
public class SimpleEnableAdmissionControlIT extends OpenSearchIntegTestCase {
    ...
    public static final Settings settings = Settings.builder()
        ...
        .put(IOBasedAdmissionControllerSettings.IO_BASED_ADMISSION_CONTROLLER_TRANSPORT_LAYER_MODE.getKey(), "enforced")
        .build();
    ...
    public void testAdmissionControlRejectionFlow() {
        ...
        updateSettingsRequest.transientSettings(
            Settings.builder()
                .put(IOBasedAdmissionControllerSettings.IO_BASED_ADMISSION_CONTROLLER_TRANSPORT_LAYER_MODE.getKey(), "disabled")
        );
        ...
        assertEquals(admissionControlServiceReplica.getAdmissionControllers().size(), 1);
        assertEquals(admissionControlServiceReplica.getAdmissionControllers().get(0).getRejectionCount(), 1);
    }
